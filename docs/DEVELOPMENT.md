...
Ограничение Linux: сохранение OAuth-сессии требует адаптера защищённого хранилища. Nix-сборку необходимо проверить на целевой системе; Windows-тесты не заменяют такую проверку.
